...
if __name__ == '__main__':
    ...
    cfg.log_root="/run/media/lasercat/writebuffer/310-vis/iiit/";
    ...
    modset.load("_E3_I100000");
    # modset.bfloat16();

    e=neko_environment(assets_dict={},queue_dict=trqd,modset=modset);

    tac = af.get_debuggers({"main": tedd}, anchors, os.path.join(cfg.log_root, "iit5k_E3_I100000"), None, "", False, 9);

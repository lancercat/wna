...
class case_inv_acr_fps_reporter(neko_module_wrapping_agent):
    ...
    def reset(this,name,has_unk):
        ...
        this.recorder.reset(name+this.variant);
    ...
    def set_etc(this,param):
        this.variant=neko_get_arg(this.PARAM_variant,param,"");
